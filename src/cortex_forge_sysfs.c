...
static ssize_t dla0_freq_show(struct device* dev, struct device_attribute* attr, char* buf)
{
...
static ssize_t dla0_temp_show(struct device* dev, struct device_attribute* attr, char* buf)
{
...
static ssize_t dla0_load_show(struct device* dev, struct device_attribute* attr, char* buf)
{
...
static ssize_t dla1_freq_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
static DEVICE_ATTR_RO(dla1_freq);

static ssize_t dla1_temp_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
static DEVICE_ATTR_RO(dla1_temp);

static ssize_t dla1_load_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
static DEVICE_ATTR_RO(dla1_load);

static ssize_t pva0_freq_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
static DEVICE_ATTR_RO(pva0_freq);

static ssize_t pva0_temp_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
static DEVICE_ATTR_RO(pva0_temp);

static ssize_t pva0_load_show(struct device* dev, struct device_attribute* attr, char* buf)
{
    return sysfs_emit(buf, "0\n");
}
